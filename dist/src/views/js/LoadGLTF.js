Object.assign(window, function () {
            ...
            if (path === 'weights') {
                ...
                var ensureKeyType = function (expectedKeyType) {
                    if (keyType !== expectedKeyType) {
                        console.warn('Unexpected key type: ' +
                            '"' + keyType + '" ' +
    ...
    function translateMesh(data, resources) {
        ...
        data.primitives.forEach(function (primitive) {
            ...
            var aabb = new pc.BoundingBox(new pc.Vec3((max[0] + min[0]) / 2, (max[1] + min[1]) / 2, (max[2] + min[2]) / 2), new pc.Vec3((max[0] - min[0]) / 2, (max[1] - min[1]) / 2, (max[2] - min[2]) / 2));
            mesh.aabb = aabb;
